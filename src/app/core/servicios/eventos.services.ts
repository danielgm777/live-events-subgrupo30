...
export class EventosService {
 ...
 //Servicio para obtener los eventos predeterminados
  ...
  //Servicio para obtener los eventos. Si no hay eventos en memoria, se inicializan con los predeterminados
  getEventos(): any[] {
